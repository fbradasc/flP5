 ...
 *
 * $Id: DataBuffer.h,v 1.6 2002/10/19 16:51:35 marka Exp $
 */
...
#define diff(location,data,mask)  ( ((location)&(mask)) != ((data)&(mask)) )
...
public:
    ...
    /** Sets the word size. */
    void set_wordsize(int wordsize=16);
     ...
     */
    bool isblank(size_t addr, unsigned int clearvalue=0);
